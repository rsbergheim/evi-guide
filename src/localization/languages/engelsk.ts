...
const engelsk: Partial<Localization> = {
    ...
    beginnerLevelDescription: 'Learn basic skills and safety in the mountains.',
    expertLevelTitle: 'Expert Courses',
    expertLevelDescription: 'Elevate your skills to new heights and challenge yourself.',
